		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DemoApp",
									"targetURL": "#sapbtpabcdemoproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpabcdemoproject-display": {
								"semanticObject": "sapbtpabcdemoproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.abc.demoproject",
									"url": sap.ui.require.toUrl("sap/btp/abc/demoproject")
								}
							}
						}
					}
